...
import 'dart:io';
import 'dart:math';
import 'package:kbc/Lifelines/PAF.dart';
import 'package:kbc/Lifelines/audiencePoll.dart';
import 'package:kbc/amountDrawer.dart';
import 'package:kbc/data.dart';
import 'package:kbc/finalPage.dart';
        ...
        body: Padding(
          ...
          child: ListView(
            children: <Widget>[
              ...
              Expanded(
                child: Center(child: Text("Total: ₹ "+"$totalAmount",textScaleFactor: 2,)),
              ),
              Padding(
